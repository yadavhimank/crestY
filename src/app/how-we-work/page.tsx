...
export const metadata: Metadata = {
  title: "How We Work",
  description:
    "Four phases, one loop: Observe, Simplify, Build, Deploy. Every engagement ends with operators who own the outcome — and artefacts any non-engineer can read.",
  openGraph: {
    title: "How We Work · Mettle",
    description: "Diagnose before you build. Build like the system has to last. Four phases, defined outputs.",
    url: "https://mettle.co/how-we-work",
  },
  twitter: { title: "How We Work · Mettle" },
  alternates: { canonical: "https://mettle.co/how-we-work" },
};

const PHASES: { n: string; icon: IconName; t: string; d: string; out: string; duration: string; artefacts: string[]; body: string }[] = [
  {
    n: "01", icon: "observe", t: "Observe",
    d: "Interview teams. Inspect tools. Map how work actually moves through your business today.",
    out: "A truthful operating map", duration: "1–2 weeks",
  ...
  },
  {
    ...
    out: "A blueprint your team agrees with", duration: "1 week",
  ...
  },
  {
    ...
    out: "Software that matches the business", duration: "8–12 weeks",
  ...
  },
  {
    ...
    out: "Operators who own the outcome", duration: "2 weeks · then ongoing",
...
function PhaseDiagram({ phase }: { phase: string }) {
  if (phase === "01") {
    return (
      <div style={{ border: "1px solid var(--m-line)", background: "var(--m-bg)", padding: 24, aspectRatio: "5/4", position: "relative" }}>
        ...
        <svg viewBox="0 0 480 360" style={{ width: "100%", height: "calc(100% - 24px)" }}>
          ...
          {([
            [160, 130, "CRM"], [330, 140, "SHEET"], [180, 240, "EMAIL"], [320, 250, "SLACK"],
          ] as [number, number, string][]).map(([x, y, l], i) => (
            <g key={i}>
    ...
    return (
      <div style={{ border: "1px solid var(--m-line)", background: "var(--m-bg)", padding: 24, aspectRatio: "5/4", position: "relative" }}>
        ...
        <svg viewBox="0 0 480 360" style={{ width: "100%", height: "calc(100% - 24px)" }}>
          ...
          {([[30,160],[140,160],[140,260],[290,260],[290,160],[460,160]] as [number,number][]).map(([x,y],i)=>(
    ...
    return (
      <div style={{ border: "1px solid var(--m-line)", background: "var(--m-bg)", padding: 24, aspectRatio: "5/4", position: "relative" }}>
        ...
        <svg viewBox="0 0 480 360" style={{ width: "100%", height: "calc(100% - 24px)" }}>
          ...
          ] as [string, number, number, number, number, boolean][]).map(([label, x, w, h, y, done], i) => (
            <g key={i}>
  ...
  return (
    <div style={{ border: "1px solid var(--m-line)", background: "var(--m-bg)", padding: 24, aspectRatio: "5/4", position: "relative" }}>
      ...
      <svg viewBox="0 0 480 360" style={{ width: "100%", height: "calc(100% - 24px)" }}>
        ...
        {([[60,100],[110,140],[80,200],[130,240]] as [number,number][]).map(([x,y],i)=>(
        ...
        {([[360,100],[410,140],[380,200],[430,240]] as [number,number][]).map(([x,y],i)=>(
...
function EthosColumn({ label, rows, positive }: { label: string; rows: [IconName, string][]; positive?: boolean }) {
  return (
...
export default function HowWeWorkPage() {
  const ARTEFACTS: [IconName, string, string][] = [
